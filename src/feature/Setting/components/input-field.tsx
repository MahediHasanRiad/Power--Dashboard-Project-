  ...
  return (
    <section>
      ...
      <input
        ...
        className="w-full bg-card-bg-0 border border-card-bg-0 border-white rounded-lg px-4 py-4 text-white text-sm focus:outline-none focus:border-[#D4A017]/50 transition-colors"
      />
    </section>
  );
}
