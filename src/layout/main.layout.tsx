  ...
  const MenuContent = () => (
    <section className="flex flex-col h-[calc(100vh-100px)]">
      ...
      <div className="mt-auto mb-6">
        <DashboardMenuButton Icon={LogOut} text="Log Out" pageLink="logout"/>
      </div>
    </section>
  );
      ...
      <section className="relative grid grid-cols-6">
        ...
        >
          <div className="flex justify-between items-center mb-8">
            <span className="text-[#D4A017] font-bold tracking-widest text-sm uppercase">
              Navigation
            </span>
            <button
              onClick={() => setIsMobileMenuOpen(false)}
